...
This project involves the development of a PONG game enhanced with a Mandelbrot fractal background. 
The project uses the PYNQ-Z2 board.
...
Bitstream file (.bit): For direct download to the FPGA: 
...
- Import the provided source files.
  ...
  Note: Depending on your deployment setup, you may need to adjust the file paths within the project 
  to match your file structure.

- Synthesize, implement, and generate the bitstream (or use the already generated bitstream file).
- Program the FPGA using the provided `.bit` file.
